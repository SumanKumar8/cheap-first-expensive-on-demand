...
set_input_delay -clock spkclk -rise -max $INPUT_DELAY_SPKCLK [get_ports vth*]
set_input_delay -clock spkclk -fall -max $INPUT_DELAY_SPKCLK [get_ports vth*]

set_input_delay -clock spkclk -rise -max $INPUT_DELAY_SPKCLK [get_ports decay*]
set_input_delay -clock spkclk -fall -max $INPUT_DELAY_SPKCLK [get_ports decay*]

set_input_delay -clock spkclk -rise -max $INPUT_DELAY_SPKCLK [get_ports grow*]
set_input_delay -clock spkclk -fall -max $INPUT_DELAY_SPKCLK [get_ports grow*]

set_input_delay -clock spkclk -rise -max $INPUT_DELAY_SPKCLK [get_ports vrest*]
set_input_delay -clock spkclk -fall -max $INPUT_DELAY_SPKCLK [get_ports vrest*]

set_input_delay -clock spkclk -rise -max $INPUT_DELAY_SPKCLK [get_ports reset*]
set_input_delay -clock spkclk -fall -max $INPUT_DELAY_SPKCLK [get_ports reset*]

set_input_delay -clock spkclk -rise -max $INPUT_DELAY_SPKCLK [get_ports refractory*]
set_input_delay -clock spkclk -fall -max $INPUT_DELAY_SPKCLK [get_ports refractory*]
...
set_input_delay -clock memclk -rise -max $INPUT_DELAY_MEMCLK [get_ports rd_*]
set_input_delay -clock memclk -fall -max $INPUT_DELAY_MEMCLK [get_ports rd_*]

set_input_delay -clock memclk -rise -max $INPUT_DELAY_MEMCLK [get_ports rst_acc]
set_input_delay -clock memclk -fall -max $INPUT_DELAY_MEMCLK [get_ports rst_acc]

set_input_delay -clock memclk -rise -max $INPUT_DELAY_MEMCLK [get_ports inspk*]
set_input_delay -clock memclk -fall -max $INPUT_DELAY_MEMCLK [get_ports inspk*]
