...
set_input_delay -clock memclk -rise -max $INPUT_DELAY_MEMCLK [get_ports monitor_*]
set_input_delay -clock memclk -fall -max $INPUT_DELAY_MEMCLK [get_ports monitor_*]

set_input_delay -clock spkclk -rise -max $INPUT_DELAY_SPKCLK [get_ports inspk*]
set_input_delay -clock spkclk -fall -max $INPUT_DELAY_SPKCLK [get_ports inspk*]
